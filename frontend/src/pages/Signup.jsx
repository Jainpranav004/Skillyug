...
import { signupSchema, checkPasswordStrength } from "../lib/validation";
import { 
  Eye, 
  EyeOff, 
  Mail, 
...
const SignupForm = () => {
  ...
  const getPasswordStrengthBgColor = (score) => {
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <label key={type.value} className="relative cursor-pointer">
                    <input {...register("userType")} type="radio" value={type.value} className="sr-only" />
